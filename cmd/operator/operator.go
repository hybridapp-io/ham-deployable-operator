...
import (
	...
	"github.com/hybridapp-io/ham-deployable-operator/pkg/apis"
	"github.com/hybridapp-io/ham-deployable-operator/pkg/controller"
	"github.com/hybridapp-io/ham-deployable-operator/version"
...
func RunManager(sig <-chan struct{}) {
	...
	err = leader.Become(ctx, "ham-deployable-operator-lock")
	if err != nil {
		klog.Error(err, "")
		os.Exit(errorExitCode)
	}
